...
public class AppointmentFragment extends Fragment {
        ...
        FirebaseDatabase.getInstance().getReference().child("ConfirmedDocAppointments")
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (appointmentRequestList.isEmpty()) {
                    showEmptyState("No confirmed appointments yet.");
                } else {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                progressBar.setVisibility(View.GONE);
                showEmptyState("Error loading appointments: " + error.getMessage());
    ...
    private void filter(String s){
        ...
        for(AppointmentRequest req : appointmentRequestList){
            // FIXED: Using public field Name instead of getName()
        ...
        if (filteredlist.isEmpty() && !s.isEmpty()) {
            ...
            recyclerView.setVisibility(View.VISIBLE);
            emptyView.setVisibility(View.GONE);
            // SAFETY CHECK: Ensure activity is valid
            if (getActivity() != null) {
