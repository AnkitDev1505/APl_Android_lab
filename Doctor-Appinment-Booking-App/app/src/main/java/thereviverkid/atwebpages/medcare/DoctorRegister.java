...
public class DoctorRegister extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        goToLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(DoctorRegister.this, LoginActivity.class).putExtra("ForPatient",false));
                    ...
                    FirebaseAuth.getInstance().createUserWithEmailAndPassword(email,pass).addOnCompleteListener(DoctorRegister.this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                FirebaseDatabase.getInstance().getReference().child("UserDetails").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).setValue(hashMap);
                                FirebaseDatabase.getInstance().getReference().child("DoctorDetails").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onFailure(@NonNull Exception e) {
                                        progressDialog.dismiss();
                                        ReusableFunctionsAndObjects.showMessageAlert(DoctorRegister.this, "Network Error", "Couldn't register, Please make sure you are connected with internet","OK", (byte) 0);
                                    }
                                });
                            } else {
                                try {
    ...
    public void onBackPressed() {
        startActivity(new Intent(DoctorRegister.this, DoctorLoginRegisterChoice.class));
